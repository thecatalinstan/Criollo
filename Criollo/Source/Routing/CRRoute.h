...
+ (CRRoute *)routeWithControllerClass:(__unsafe_unretained Class )controllerClass prefix:(NSString *)prefix;
+ (CRRoute *)routeWithViewControllerClass:(__unsafe_unretained Class )viewControllerClass nibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil prefix:(NSString * _Nullable)prefix;
...
- (instancetype)initWithControllerClass:(__unsafe_unretained Class )controllerClass prefix:(NSString *)prefix;
- (instancetype)initWithViewControllerClass:(__unsafe_unretained Class )viewControllerClass nibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil prefix:(NSString * _Nullable)prefix;
