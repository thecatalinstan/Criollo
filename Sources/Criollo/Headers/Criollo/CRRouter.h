...
/// @param path The path specification.
/// @param block The `CRRouteBlock` to be executed.
/// @param recursive Specifies wether the path spec should be matched exactly or if it should be treated aa a prefix.
...
/// Adds a block to a pathspec, for the CONNECT method, non-recursively.
///
/// @param path  The path specification.
/// @param block The `CRRouteBlock` to be executed.
- (void)connect:(NSString *_Nullable)path block:(CRRouteBlock)block;
...
///  @param path            The path specification.
///  @param controllerClass The class name of the controller to be used.
///  @param recursive       Specifies wether the path spec should be matched exactly it should be treated aa a prefix.
///  @param method          The HTTP request method
...
/// @param contentDisposition The `CRContentDisposition` used to build `Content-disposition` HTTP header.
